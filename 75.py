				...
				try:
					...
					if "logged_in_user" in str(xyaaXD) or "sessionid" in ses.cookies.get_dict():
						...
						try:
							...
							print('\n')
							cetak(nel(pepekXD,style='',title='\r[green]MANTAP BUL GASKAN[white]'))
							...
							pepekXD = nel(adit, style='green')
							print('\n')
							cetak(nel(pepekXD,style='',title='\r[green]MANTAP BUL GASKEN[white]'))
						...
						print('\n')
						cetak(nel(pepekXD,style='', title='\r[yellow]CABUL BANGSAT[white]'))
